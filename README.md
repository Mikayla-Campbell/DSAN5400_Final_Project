...
We've split the list of 197 terms into 5 categories: "ability", "climate", "class", gender/sexuality ( titled "gs" ), and race/ethnicity ( titled "re" ). We've chosen 5 words from the list of 197 terms to be representative of each category.
